...
| `HOSTINGER_SSH_PORT` | Puerto SSH (Hostinger usa 65002) |
...
```
/home/u938009968/domains/gastos.rdtecno.net/   ← HOSTINGER_REMOTE_PATH
├── src/
├── templates/
├── vendor/
...
2. `public_html/assets` — **symlink** (no carpeta) que apunta a `public/assets`:
   ```bash
   ln -s /home/u938009968/domains/gastos.rdtecno.net/public/assets \
         /home/u938009968/domains/gastos.rdtecno.net/public_html/assets
   ```
...
```bash
ssh -i %TEMP%\gastos_hogar_deploy_key -p 65002 u938009968@145.223.77.254
